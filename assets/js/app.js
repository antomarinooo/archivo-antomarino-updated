...
- Copywriting y brand voice
  ...
  { text: 'Bioilustraciones. (s.f.). Bioilustraciones [Instagram].', url: 'https://www.instagram.com/bioilustraciones.cl/' },
  { text: 'Bosque Chileno. (s.f.). Novedades.', url: 'https://bosquechileno.cl/collections/novedades' },
  ...
  { text: 'Chile es Tuyo. (s.f.). Flora endémica de Chile: nuestra propia naturaleza.', url: 'https://chileestuyo.cl/flora-endemica-de-chile-nuestra-propia-naturaleza/' },
  ...
  { text: 'EcoCamp Patagonia. (s.f.). Flora nativa de la Patagonia.', url: 'https://www.ecocamp.travel/es/flora-nativa-de-la-patagonia' },
  ...
  { text: 'Ilustradores de Naturaleza. (s.f.). Galería [CINC].', url: 'https://ilustradoresnatura.wixsite.com/cinc/galeria' },
  ...
  { text: 'Ministerio del Medio Ambiente. (s.f.). Libro para colorear [PDF].', url: 'https://repositorioambiental.mma.gob.cl/wp-content/uploads/2019/10/Libro-Colorear.pdf' },
  ...
  { text: 'Trekking Chile. (s.f.). Flora chilena: Chile Altiplano.', url: 'https://www.trekkingchile.com/es/informaciones/flora-chilena/chile-altiplano/' },
  ...
  { text: 'Wikipedia. (s.f.). Flora de Bolivia.', url: 'https://es.wikipedia.org/wiki/Flora_de_Bolivia' },
]
  },
  {
    id: 'p2',
